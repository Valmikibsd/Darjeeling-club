...
function IUGalleryMain() {
    ...
    fdata.append("filenmes", filenameorginal);
        ...
        $.ajax({
            type: "POST",
            url: '/Admin/clubmaster/IUGalleryMain',
            dataType: "JSON",
...
function ShowDataInTable() {
    $.ajax({
        url: '/Admin/clubmaster/ShowGalleryMain',
        dataType: 'JSON',
        type: 'GET',
        ...
        success: function (data) {
            ...
            $.each(data, function (key, item) {
                ...
                html += '<td><img src="/GalleryMain/' + item.image + '" alt="your image" width="75" height="80" /></td>';
                if (item.display == "1") {
...
function DeletebyId(Id) {
    ...
    if (checkstr == true) {
        $.ajax({
            url: '/Admin/clubmaster/DeleteGalleryMain',
...
function Editbyid(Id, display) {
    ...
    $.ajax({
        url: '/Admin/clubmaster/EditGalleryMain',
        data: JSON.parse(PetObj),
        dataType: 'JSON',
        type: 'POST',
        success: function (result) {
            ...
            $('#imgfile').attr('src', "/GalleryMain/" + result.image + "");
