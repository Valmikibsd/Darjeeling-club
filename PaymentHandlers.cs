...
namespace PaymentHandlers {
    public class PaymentHandler {
        ...
        public PaymentHandler(string configPath) {
            paymentHandlerConfig = PaymentHandlerConfig.Instance;
            paymentHandlerConfig.WithInstance(configPath);
        }
        ...
        {
            ClsUtil.WriteLogFile("logs", "input'" + "h1" + "'", "", "", "", "", "", "", "execQuery", "");
            ...
            {
                ClsUtil.WriteLogFile("logs", "input'" + "h2" + "'", "", "", "", "", "", "", "execQuery", "");
                parameters = parameters != null ? parameters : new Dictionary<string, object>();
                parameters["payment_page_client_id"] = paymentHandlerConfig.PAYMENT_PAGE_CLIENT_ID;
            }
            ClsUtil.WriteLogFile("logs", "input'" + "h3" + "'", "", "", "", "", "", "", "execQuery", "");
        ...
        private async Task<dynamic> CallAPI(string path, HttpMethod method, string apiTag, ContentType contentType, Dictionary<string, object> parameters) {
                ...
                ClsUtil.WriteLogFile("logs", "input'" + "h5" + "'", "", "", "", "", "", "", "execQuery", "");
            ...
            try
            {
                using (var client = new HttpClient())
                {
                    ...
                    ClsUtil.WriteLogFile("logs", "input'" + "h6" + "'", "", "", "", "", "", "", "execQuery", "");
                    ...
                    try
                    {
                        ...
                        ClsUtil.WriteLogFile("logs", "input'" + "h7" + "'", "", "", "", "", "", "", "execQuery", "");
                ...
                ClsUtil.WriteLogFile("logs", "input'" + "h8" + "'", "", "", "", "", "", "", "execQuery", "");
          ...
          var  responseString = await reader.ReadToEndAsync().ConfigureAwait(false);
            //ClsUtil.WriteLogFile("logs", "input'" + responseString + "'", "", "", "", "", "", "", "execQuery", "");
         ///  ClsUtil.WriteLogFile("logs", "input'" + response + "'", "", "", "", "", "", "", "execQuery", "");
        ...
        private dynamic HandleResponse(HttpResponseMessage response, string responseString, SimpleLogger logger) {
            ...
            ClsUtil.WriteLogFile("logs", "input'" + "h9" + "'", "", "", "", "", "", "", "execQuery", "");
            string responseId = null;
                ...
                if (response.StatusCode >= System.Net.HttpStatusCode.OK && response.StatusCode < System.Net.HttpStatusCode.BadRequest) {
                    try {
                    ClsUtil.WriteLogFile("logs", "input'" + "1h10" + "'", "", "", "", "", "", "", "execQuery", "");
    ...
    public class Config {
        public string API_KEY { get; set; } = "B16B0F26C2E457795379D141A79DAD";
        public string MERCHANT_ID { get; set; } = "54978";
        public string PAYMENT_PAGE_CLIENT_ID { get; set; } = "54978";
        public string BASE_URL { get; set; } = "https://smartgateway.hdfcbank.com";
        public bool ENABLE_LOGGING { get; set; } = true;
        public string RESPONSE_KEY { get; set; } = "ABBD3B55E3645479AEE68D48880900";
        public string LOGGING_PATH { get; set; } = "./logs/PaymentHandler.log";
    }
    ...
    public class PaymentHandlerConfig {
        ...
        public PaymentHandlerConfig WithInstance (string configPath) {
